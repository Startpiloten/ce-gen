...
# TCA
cp ${libdir}/cTypes/${libcType}/tt_content_${libcType}.php ${extensiondir}/Configuration/TCA/tt_content_${libcType}.php
sed -i '' "s/provider/${extname}/g" ${extensiondir}/Configuration/TCA/tt_content_${libcType}.php
...
if [ -f "${extensiondir}/Configuration/TCA/tt_content_${libcType}.php" ]
then
    echo
