...
envsubst '${extname} ${cename} ${cenameUpper} ${cetitle} ${cedescription} ${mmtitleLower} ${mmtitle}' < $bindir/lib/mm/tt_content_ctype.php > $extensiondir/Configuration/TCA/Overrides/tt_content_${cename}.php
